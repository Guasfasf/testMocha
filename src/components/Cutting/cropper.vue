  ...
  <div>
    <div class="cropper-content">
      ...
      <div class="cropper">
        <vueCropper ref="cropper" :img="option.img" :outputSize="option.size" :outputType="option.outputType"
                    ...
                    :fixed="option.fixed" :fixedNumber="fixedNumber"></vueCropper>
      </div>
      <!-- 预览框 -->
    ...
    <!--<div class="footer-btn">-->
      ...
      <!--<div class="upload-btn">-->
        ...
        <!--&lt;!&ndash;<el-button type="primary" @click="uploadImg">上传</el-button>&ndash;&gt;-->
      <!--</div>-->
    <!--</div>-->
  </div>
</template>
...
export default {
  data () {
    return {
      previews: {}, // 预览数据
      option: {
        img: 'https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=3991226494,1770909328&fm=27&gp=0.jpg', // 裁剪图片的地址  (默认：空)
